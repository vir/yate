...
/**
 * SIP digest auth nonce holder
 **/
class YSIP_API SIPAuthNonce
{
private:
    unsigned long m_nc;
    String m_nonce;
...
public:
     ...
     * @param noncer nonce storage and counter for qop
	...
	const String& meth, const String& uri, TelEngine::SIPAuthNonce& noncer, bool proxy = false) const;
     ...
     * @return A new authorization line to be used in a new transaction
     */
    MimeAuthLine* buildAuth(const SIPMessage& original, SIPAuthNonce& noncer) const;
