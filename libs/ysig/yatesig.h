 ...
 */
class YSIG_API SignallingComponent : public GenObject
{
 ...
 */
class YSIG_API SignallingElement : public NamedString
{
};
 ...
 */
class YSIG_API SignallingCallControl
{
};
 ...
 */
class YSIG_API SS7Router : public SS7L3User, public SS7Layer3
{
public:
    /**
     * Push a Message Signal Unit down the protocol stack
 ...
 */
class YSIG_API SS7MTP3 : public SS7Layer3, public SS7L2User
{
public:
    /**
     * Constructor
 ...
 */
class YSIG_API ISUPMessage : public SignallingMessage
{
public:
    enum Type {
